...
public class UserDashboardiconvalidation2 extends BaseClass{
	ExtentTest logger;
	WebDriverWait wait;
  ...
  @Test(enabled = true, dataProvider = "standardUserData",groups = "smoke")
    public void UserDashboardIconValidation(String username,String password,String Usertype,String Dashboardicons,String userDropdown) throws InterruptedException, IOException
    {
  	...
  	login.dashboardiconValidation(driver2, logger, Usertype, wait, Dashboardicons);
